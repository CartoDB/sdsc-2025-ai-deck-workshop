...
export const mcpToolConfig: MCPToolConfig = {
  ...
  serverUrl: process.env.NEXT_PUBLIC_CARTO_MCP_SERVER_URL || process.env.CARTO_MCP_SERVER_URL || "",
  apiToken: process.env.NEXT_PUBLIC_CARTO_API_TOKEN || process.env.CARTO_API_TOKEN || "",
